       ...
       return (
               <SafeAreaView style={styles.mainContainer}>
                   ...
                   <TouchableOpacity style={styles.CustomerField}>
                       ...
                       <TextInput style={{ flex: 1,fontSize:14,fontWeight:fonts.sf }} placeholder="Search Shop,owner,mobile" placeholderTextColor='#6A7282'/>
                   </TouchableOpacity>
                   ...
                   <View style={styles.card}>
                       <View style={styles.TotalAmountContainer}>
                           ...
                           <TouchableOpacity style={styles.customerContainer}>
                               <Text customersText>20 customers</Text>
                           </TouchableOpacity>
                       </View>
                   ...
                   <TouchableOpacity style={styles.download}>
                       <Text style={{color:colors.white,fontSize:12,fontWeight:'800'}}>Download PDF</Text>
                   </TouchableOpacity>
