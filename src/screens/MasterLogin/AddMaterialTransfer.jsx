...
import { AddRawTransfer, GetAllRawMaterialData, GetCopackers } from "../../redux/reducers/MasterLogin/AddProduct";
...
const Addmaterialtransfer = () => {
    ...
    console.log("Get copackersdata  in material taransfer screen==============>", copackersData);
    ...
    const handleDateChange = (event, selectedDate) => {
        setShowDate(false); // close picker
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await dispatch(AddRawTransfer(payload)).unwrap();
            Alert.alert(
        ...
        <View style={styles.container}>
            ...
            <SafeAreaView >
                <TouchableOpacity style={commonstyles.header} onPress={() => navigation.goBack()}>
                    ...
                    <Text style={commonstyles.title}>Add Material Transfer</Text>
                </TouchableOpacity>
            </SafeAreaView>
            ...
            <ScrollView style={styles.main} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.card}>
                    ...
                    <View style={styles.head}>
                        ...
                        <View style={[styles.for_border_dropdown, validerror?.transferToName ? styles.errorBorder : null]}>
                            <Dropdown
                    ...
                    <View style={styles.head}>
                        ...
                        <View style={[styles.for_border, validerror.phno ? styles.errorBorder : null]}>
                            <TextInput placeholder="contact details" style={styles.inputfield} placeholderTextColor="#888" value={phno} onChangeText={setPhno} maxLength={10} keyboardType="numeric" editable={false} />
                        </View>
                        {
                            validerror.phno ? (
                                    ...
                                    <View style={styles.right}>
                                        ...
                                        <View style={[styles.for_newborder, validerror[`conversion_${index}`] && styles.errorBorder]}>
                                            <TextInput
                                                ...
                                                //     setMaterial(prev =>
                                                //         prev.map(matl =>
                                                //             matl.id === item.id ? { ...matl, conversion: text } : matl
                                                //         )
                                                //     )
                                                // }}
