...
import { EditQuestions, QuestionsPost } from "../../redux/reducers/TelecallerLogin/AddCallers";
...
const EditQuestionForm = () => {
    ...
    console.log("Edit Data item in Edit Qns Screen ------------>", EditData);

    useEffect(() => {
        if (EditData) {

            // ✅ Set Call Type
            setCall(EditData.questionType);

            // ✅ Convert questions array to your state format
            const formattedQuestions = EditData.questions.map((q, index) => ({
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await dispatch(EditQuestions({ id, payload })).unwrap();
            Alert.alert(
        ...
        <View style={[styles.container]}>
            ...
            <SafeAreaView >
                <TouchableOpacity style={commonstyles.header} onPress={() => navigation.goBack()}>
                    ...
                    <Text style={commonstyles.title}>Edit Questions</Text>
                </TouchableOpacity>
            </SafeAreaView>
