            ...
            <ScrollView showsVerticalScrollIndicator={false} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} />}>
                ...
                <View style={styles.card}>
                    ...
                    <View style={styles.top}>
                        <View style={styles.left}>
                            ...
                            <Text style={styles.Address}>Payment Type</Text>
                                ...
                                renderItem={({ item }) => {
                                    return (
                                        ...
                                        <View style={{ paddingTop: 2 }} >
                                            ...
                                            <View style={styles.top}>
                                                <Text style={styles.title}>{item.productName}</Text>
                                                <Text style={[styles.title, { color: colors.homeblue }]}>₹{item.amount}</Text>
                                            </View>
                ...
                <View style={[styles.card, { gap: 15 }]}>
                    ...
                    <View style={styles.dashed}>
                        ...
                        <TextInput style={styles.inputfield} placeholder="Discount" keyboardType="numeric" editable={false} value={String(reportData?.discount ?? 0)} placeholderTextColor="#888" />
                    </View>
...
export default FactorySalesOverView