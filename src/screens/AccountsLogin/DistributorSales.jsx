...
import { GetDistributorSaleData } from "../../redux/reducers/AccounsLogin/VehicleDetails";
...
const DistributorSales = () => {
    ...
    useFocusEffect(
        useCallback(() => {
            ...
            dispatch(GetDistributorSaleData("DISTRIBUTOR"));
    ...
    const onRefresh = useCallback(() => {
        setRefreshing(true);
        dispatch(GetDistributorSaleData("DISTRIBUTOR"));
        // small delay (optional, for smooth UX)
    ...
    const { GetDistributorData } = useSelector((state) => state.DistributorsalesData);
    console.log("Get Distributros sales  Data------------------->", GetDistributorData);

    const { getEmpdata } = useSelector((state) => state.GetEmp);
    console.log("*********GetEmployess Data All Employess Data in  Distributor  Sale Screen **********", getEmpdata);
    ...
    console.log("Logined User Data async storege in Accounts Login  Distributor Sale Screen --------------------->", userData);
        ...
        <View style={styles.container}>
            <SafeAreaView style={styles.top} >
                <TouchableOpacity style={styles.header} onPress={() => navigation.goBack()}>
                    ...
                    <Text style={styles.title}>Distributor Sale</Text>
                </TouchableOpacity>

                {
                    !isAdmin && (
                        <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("AddSalesInDistributorsales")}>
            ...
            <View style={styles.body}>
                {
                    loading ? (
                        ...
                        <FlatList
                            ...
                            onRefresh={onRefresh}        // function call

                            renderItem={({ item }) => {
                                // DistributorSalesOverView "distributoritems", { ItemsData: item })}
                                return (

                                    <TouchableOpacity style={styles.card} onPress={() => navigation.navigate("DistributorSalesOverView", { reportData: item })}>
