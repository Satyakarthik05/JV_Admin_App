        ...
        <View style={styles.container}>
            ...
            <SafeAreaView>
                <TouchableOpacity style={styles.head} onPress={() => navigation.goBack()}>
                    ...
                    <Text style={styles.title}>Factory Sale Items</Text>
                </TouchableOpacity>
            </SafeAreaView>
            ...
            <FlatList
                ...
                renderItem={({ item }) => {
                    return (
                        <TouchableOpacity style={styles.card} onPress={() => navigation.navigate("FactorySalesOverView",{reportData:ItemsData})}>
...
export default FactorySaleItems